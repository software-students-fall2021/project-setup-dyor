    ...
    <Box className="settings">
      ...
      <Paper className="settingsTile tools" elevation={3}>
        ...
        <Box className="setting currency">
          ...
          <DropDownMenu className="handle" selectedValue={currency} options={Currencies} set={setCurrency}/>
        </Box>
        <Divider variant="inset" />
        <Box className="setting regions">
          ...
          <DropDownMenu className="handle" selectedValue={region} options={regions} set={setRegion}/>
        </Box>
      </Paper>
      <Paper className="settingsTile user" elevation={3}>
        <Box className="iconAndLabel">
