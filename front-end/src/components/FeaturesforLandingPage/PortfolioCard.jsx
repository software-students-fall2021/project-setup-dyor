      ...
      <div className={classes.root_about_us} id="About_us">
        ...
        <Bounce>
          <p className={classes.description}>
            Allow user to add Stock and Crypto to their Wallet and display their
            cumulative profit/loss thus far through Graphs. Allow user to add
            Stock and Crypto to their Wallet and display their cumulative
            profit/loss thus far through Graphs. Allow user to add Stock and
            Crypto to their Wallet and display their cumulative profit/loss thus
            far through Graphs.
          </p>
        </Bounce>
      </div>
