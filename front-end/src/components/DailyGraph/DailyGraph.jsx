...
export function DailyGraph({ assetDetails, historicalPriceData }) {
    ...
    useEffect(() => {
        ...
        if (assetDetails && assetDetails.datePurchased && historicalPriceData) {
            console.log(
                `assetDetails.datePurchased ${assetDetails.datePurchased}`
            );
            ...
            const filteredData = historicalPriceData
                .map((dataElement) => {
                    return {
                        ...
                        price:
                            (dataElement.rate_high + dataElement.rate_low) / 2,
                    };
                })
                .filter((dataElement) => {
            ...
            <item>
                <div className={styles.center}>
                    ...
                    >
                        ...
                        />
                        <YAxis
                            label={<AxisLabel axisType="yAxis">USD</AxisLabel>}
                        />
                        <Tooltip />
