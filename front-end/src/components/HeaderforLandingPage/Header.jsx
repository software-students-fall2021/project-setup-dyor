...
import { AppBar, Icon, IconButton, makeStyles, Toolbar } from '@material-ui/core'
...
export default function Header() {
    ...
    return (
        <div >
            ...
            <Collapse in = {checked} {... (checked ? {timeout : 1500} : {})} collapseHeight = {50}>
                <div className = {classes.container}>
                    <h1 className= {classes.title} >
                        WELCOME TO <br /> <strong className = {classes.Emphasis}> DYOR </strong> <br/>Do Your Own Research
                    </h1>
                    <Stack spacing = {2} direction = "row" >
                        ...
                        variant = "contained" 
                        size = "large" 
                        className = {classes.Button_root2}>Sign-up</Button>
                    </Stack>
